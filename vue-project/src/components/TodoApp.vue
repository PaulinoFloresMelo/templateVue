...
<template>
    <div class="bg-accent p-10 rounded-lg shadow-lg">
        <h1 class="text-3xl text-white text-center font-bold mb-3"><ClipboardList></ClipboardList> do App</h1>
        ...
        <div v-if="!hasTodo" class="bg-primary text-white p-2 rounded-lg mt-2">
            <p><span class="text-lg"><Information></Information></span>Nothing todo? add a new task!!</p>
        </div>
    </div>
</template>